...
class ButtonAccKuliahPengganti extends StatefulWidget {
  final int id;
  final String token;
  ...
  const ButtonAccKuliahPengganti(
      {super.key,
      required this.id,
      required this.token,
  ...
  @override
  State<ButtonAccKuliahPengganti> createState() => _ButtonAccKuliahPenggantiState();
}

class _ButtonAccKuliahPenggantiState extends State<ButtonAccKuliahPengganti> {
  bool _isAcc = false;
  @override
