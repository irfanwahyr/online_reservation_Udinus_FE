...
class AppbarDaftarLaboratorium extends StatefulWidget
    implements PreferredSizeWidget {
  final String namaAdmin;
  final String imageAsset;
  final TabController? tabController;

  const AppbarDaftarLaboratorium({
  ...
  @override
  _AppbarDaftarLaboratoriumState createState() =>
      _AppbarDaftarLaboratoriumState();

  @override
  Size get preferredSize => Size.fromHeight(100);
}

class _AppbarDaftarLaboratoriumState extends State<AppbarDaftarLaboratorium>
