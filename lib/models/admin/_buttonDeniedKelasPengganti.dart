...
class ButtonDeniedKelasPengganti extends StatefulWidget {
  final int id;
  final String token;
  ...
  const ButtonDeniedKelasPengganti({
    super.key,
    required this.id,
    required this.token,
  ...
  @override
  State<ButtonDeniedKelasPengganti> createState() => _ButtonDeniedKelasPenggantiState();
}

class _ButtonDeniedKelasPenggantiState extends State<ButtonDeniedKelasPengganti> {
  bool _isAcc = false;
