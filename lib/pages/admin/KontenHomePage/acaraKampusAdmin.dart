                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Center(
                          child: DataTable(
                            ...
                            rows: List.generate(listacarakampus.length, (index) {
                              final data_acara_kampus = listacarakampus[index];
                              String fakultas = data_acara_kampus.fakultas;
                              String penanggung_jawab = data_acara_kampus.penanggung_jawab;
                              String no_whatssapp = data_acara_kampus.no_whatsapp;
                              String nama_acara = data_acara_kampus.nama_acara;
                              String nama_lab = data_acara_kampus.nama_lab;
                              String tanggal_mulai = data_acara_kampus.tanggal_mulai;
                              String tanggal_selesai = data_acara_kampus.tanggal_selesai;
                              String jam_mulai = data_acara_kampus.jam_mulai;
                              String jam_selesai = data_acara_kampus.jam_selesai;
                              String keterangan = data_acara_kampus.keterangan;
                              String proposal_acara = data_acara_kampus.proposal_acara;
                              String surat_peminjaman = data_acara_kampus.surat_peminjaman;
                              _no++;
