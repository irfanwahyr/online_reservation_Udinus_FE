...
class DetailG extends StatefulWidget {
  static const nameRoute = 'detailG';
  const DetailG({super.key});

  @override
  State<DetailG> createState() => _DetailGState();
}

class _DetailGState extends State<DetailG> {
  @override
